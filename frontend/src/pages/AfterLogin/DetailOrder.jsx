        ...
        <section className='detail'>
          <div className='container mt-5'>
            <div className='row mb-12'>
              <div className='col-md-4'>
                <div className='card' key={Armada.id} data-aos='fade-up' data-aos-delay={100}>
                  ...
                  <div className='card-body'>
                    ...
                    <select className=' btn btn-md btn-warning rounded-5 w-75 ms-3  text-white hover' onChange={handleDriverChange}>
                    ...
                    <form onSubmit={saveTransaksi}>
                      <div className='row p-1'>
                        ...
                        <div className='col-lg-4'>
                          ...
                          <input type='time' placeholder=' Dalam jam'  />
                        </div>
                      </div>
                      ...
                      <div className='d-flex justify-content-between align-items-center'>
                        ...
                        <button type='submit' className='btn btn-md btn-warning rounded-5 w-25 text-white'>
                          Lanjut Pemesanan
                        </button>
                      </div>
                    </form>
              ...
              <div className='text-center fw-bold mt-4' data-aos='fade-up' data-aos-delay={50}>
